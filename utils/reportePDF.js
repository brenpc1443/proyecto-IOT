  ...
  async crearReporte(datos, nombreArchivo = "reporte.pdf") {
    return new Promise((resolve, reject) => {
      try {
        ...
        // Determinar tipo de reporte - usar el título como indicador definitivo
        const esHistorial = datos.titulo.toLowerCase().includes("historial");

        console.log("Tipo de reporte:", datos.titulo);
        console.log("Es historial:", esHistorial);
    ...
    const items = [
      {
        ...
        valor: datos.resumen.total_sesiones || 0,
        color: "#3b82f6",
        icon: "📊",
      },
      {
        label: "Sesiones Pagadas",
        valor: datos.resumen.pagadas || 0,
        color: "#22c55e",
        icon: "✓",
      },
      {
        label: "Sesiones Pendientes",
        valor: datos.resumen.pendientes || 0,
        color: "#f59e0b",
        icon: "⏳",
      },
      {
        label: "Sesiones Activas",
        valor: datos.resumen.activas || 0,
        color: "#ef4444",
        icon: "▶",
      },
    ];
